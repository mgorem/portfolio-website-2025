        ...
        <Sheet>
            <SheetTrigger asChild>
                <Button variant="ghost"
                    ...
                    bg-neutral-800 py-5 px-5 rounded-full
            ...
            <SheetContent
                side="right" 
                className="w-84 bg-neutral text-white
                py-6 pl-10">
                <SheetTitle 
                ...
                <nav className="flex flex-col gap-4">
                    {navLinks.map((link) => {
                        ...
                        className={cn(
                            'text-neutral-300 flex items-center gap-2 hover:text-primary transition colors, duration-200 text-base', active === link.link && 'text-primary',
                        )}
                        >
                ...
                <div className="mt-30">
                    <p className="pb-2">Let's Engage</p>
